    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        <SheetHeader>
          ...
          {/* Preorder Notice */}
          <div className="mt-4">
            <div className="bg-yellow-400/15 backdrop-blur-sm rounded-lg border border-yellow-400/30 p-3">
              <div className="flex items-start gap-2">
                <svg className="w-5 h-5 text-yellow-400 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                </svg>
                <div className="flex-1">
                  <p className="text-yellow-400 font-semibold text-sm mb-1">PREORDER</p>
                  <p className="text-white/80 text-xs leading-relaxed">
                    Orders will be placed based on demand. 
                    <span className="font-semibold text-yellow-400">NO SHIPPING</span> - 
                    Pickup at Newnan football games only!
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div className="border-t border-white/20 pt-4">
                ...
                {/* Preorder Reminder in Checkout */}
                <div className="mt-4 p-3 rounded-lg" style={{
                  backgroundColor: 'rgba(251, 191, 36, 0.1)',
                  border: '1px solid rgba(251, 191, 36, 0.3)'
                }}>
                  <p className="text-xs text-center text-yellow-400/90 font-medium">
                    Remember: This is a preorder. Items will be distributed at Newnan football games.
                  </p>
                </div>
              </div>
            </div>
