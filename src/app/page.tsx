    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 px-4 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-gray-900 dark:text-white">Our Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Media Upgrades Coming Soon</h3>
              <p className="text-gray-600 dark:text-gray-300">New services like drone, video, and 3D tours launching soon - let&apos;s grow together.</p>
            </div>
          </div>
        </div>
      </section>
